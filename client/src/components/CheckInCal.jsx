...
class CheckInCal extends React.Component {
  ...
  render() {
    ...
    console.log('this.state.current_month_available: ', this.state.current_month_available)
    console.log('this.state.current_month_inventory: ', this.state.current_month_inventory)
    let startPast = this.state.current_month_available[0];
    let currentMonthEndIndex = (this.state.current_month_inventory.length - 1);
    console.log('currentMonthEndIndex: ', currentMonthEndIndex)
    console.log('startPast: ', startPast)
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th className="currentDatePickerMonth next" colspan="7" onClick={this.nextClick}>>{this.state.current_month_string} 2021 </th>
                </tr>
                <tr >
                ...
                <tr>
                  {week_one.map((numb, index) => {
                    ...
                    if (numb === this.state.checkInDay) {
                      ...
                      return this.state.current_month_available.indexOf(numb) === -1 || (numb < startPast && numbIndex < currentMonthEndIndex) ?
...
//237: className="datepicker datepicker-inline"
